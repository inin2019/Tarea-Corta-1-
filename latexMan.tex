...
\begin{itemize}
  \item \textbf{\textit{Símbolos: }} Cuando se requieran insertar símbolos conocidos como +, -, =, !, /, (), [], : y demás, es necesario utilizar un comando. A continuación se muestran una serie de secciones las cuales muestran como hacer inserciones de 'potencias e índices', 'fracciones', 'raíces', 'sumatorias e integrales' y 'letras griegas'.
