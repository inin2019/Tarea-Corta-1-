...
Una ventaja menos obvia, pero quizá más importante, es que LaTeX te permite claramente separar el contenido y el formato de tu documento. 
...
\begin{verbatim}
  \begin{center}
    Lorem ipsum dolor sit amet consectetur adipiscing elit blandit nibh at nisl penatibus platea, mattis pharetra conubia id lacinia malesuada vehicula proin habitant ligula curabitur.
...
Para subrayar el texto el comando empleado es  \textbackslash{}\textbf{\textit{underline}}\{Texto subrayado\}, lo que se puede ver como: \underline{Texto subrayado}.
...
%************\item \textbackslash{}center: Para alinear al centreo.*********TABLAS*********************
\section{Tablas}
